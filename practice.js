...
function bakeAndSellPies(pieType, pieQuantity, profitMargin) {
  ...
  //bakes pies and lists ingredients
  bakePie(recipe, pieType, pieQuantity);
  //prints total cost of all pies made
  let totalCost = pieCost(recipe, pieQuantity);
...
function bakePie(recipe, pieType, pieQuantity){
